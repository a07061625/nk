...
(function () {
    ...
    (function () {
        ...
        var utils = {
            ...
            cssRule: isIE ? function (key, style, doc) {
                ...
                doc = doc || document;
                var head = doc.getElementsByTagName('head')[0]; var node;
            ...
            hasClass: function (element, className) {
                className = className.replace(/(^[ ]+)|([ ]+$)/g, '').replace(/[ ]{2,}/g, ' ')
                    .split(' ');
            ...
            addClass: function (elm, classNames) {
                if (!elm) {return;}
                classNames = this.trim(classNames).replace(/[ ]{2,}/g, ' ')
                    .split(' ');
            ...
            removeClass: function (elm, classNames) {
                classNames = this.isArray(classNames) ? classNames
                    : this.trim(classNames).replace(/[ ]{2,}/g, ' ')
                        .split(' ');
                for (var i = 0, ci, cls = elm.className;ci = classNames[i++];) {
    ...
    UE.parse.register('vedio', function (utils) {
        ...
        if (video.length || audio.length) {
            ...
            var jsurl = sourcePath + '/third-party/video-js/video.js';
            var cssurl = sourcePath + '/third-party/video-js/video-js.min.css';
            var swfUrl = sourcePath + '/third-party/video-js/video-js.swf';
